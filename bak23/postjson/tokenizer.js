...
module.exports = function tokenize(input) {
    ...
    function unclosed(what) {
        throw Error('Unclosed ' + what, line, pos - offset);
    }
    ...
    while ( pos < length ) {
        ...
        case FEED:
            ...
            tokens.push(['whitespace', css.slice(pos, next),
              line, pos - offset,
              line, next - offset
            ]);
            pos = next - 1;
        ...
        case OPEN_PARENTHESES:
            ...
            if ( prev === 'url' && n !== SINGLE_QUOTE && n !== DOUBLE_QUOTE &&
                ...
                tokens.push(['symbol', css.slice(pos, next + 1),
                    line, pos  - offset,
                    line, next - offset
                ]);
                pos = next;
        ...
        case DOUBLE_QUOTE:
            ...
            tokens.push(['text', css.slice(pos, next + 1),
                line, pos  - offset,
        ...
        */
        ...
        default:
            if ( code === SLASH && css.charCodeAt(pos + 1) === ASTERICK ) {
              ...
              next = css.indexOf('\n', pos + 2); // todo
              content = css.slice(pos, next)
              nextOffset = (pos - offset) + content.length
              tokens.push(['comment', content,
                  line, pos - offset,
                  line, nextOffset
              ]);
