# Contributing to npm-hooks

:sparkles: Thanks for your contribution in advance! :tada:

First and foremost, thank you! We appreciate that you want to contribute to `npm-hooks`, your time is valuable, and your contributions mean a lot to us.
...
As a user of `npm-hooks` you're the perfect candidate to help us improve our documentation. Typo corrections, error fixes, better explanations, more examples, etc. Open issues for things that could be improved. Anything. Even improvements to this document.

Use the [`docs` label](https://github.com/tunnckoCore/npm-hooks/labels/docs) to find suggestions for what we'd love to see more documentation on.
...
The [`question` label](https://github.com/tunnckoCore/npm-hooks/labels/question) is a good place to find ongoing discussions.
...
1. **version**: what version of `npm-hooks` were you using when you experienced the bug?
