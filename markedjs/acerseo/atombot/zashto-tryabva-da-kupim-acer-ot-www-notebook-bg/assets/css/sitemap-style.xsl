	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<div id="footer">
					Generated with <a href="http://www.zashto-tryabva-da-kupim-acer-ot-www-notebook-bg.charlike.pw" title="Acer AtomBot XML Sitemap">AtomBot 1.0 XML Sitemap</a> by <a href="http://www.charlike.pw/">George Yanev</a>. This XSLT template is released under GPL.
				</div>
			</body>
		</html>
	</xsl:template>
