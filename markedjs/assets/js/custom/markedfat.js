        ...
        while (src) {
            ...
            if (cap = this.rules.url.exec(src)) {
                ...
                if (YouTube !== undefined) {
                    out = '<iframe width="500" height="280" src="//www.youtube.com/embed/' + YouTube + '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
                    continue;
                } else if (Vimeo !== undefined) {
                    out = '<iframe width="500" height="280" src="//player.vimeo.com/video/' + Vimeo + '?api=1" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
                    continue;
                } else if (Viddler !== undefined) {
                    out = '<iframe width="500" height="280" src="//www.viddler.com/player/' + Viddler + '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
                    continue;
                } else if (DailyMotion !== undefined) {
                    out = '<iframe width="500" height="280" src="//www.dailymotion.com/embed/video/' + DailyMotion + '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
                    continue;
                }/* else if (Html5) {
