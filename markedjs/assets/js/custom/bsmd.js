...
!function ($) {
  ...
  , showPreview: function() {
      ...
      if (typeof callbackContent == 'string') {
        ...
        //console.log("Ostanalo: "+content);
        if (typeof s9e.TextFormatter == 'object') {
            //fatmd(content);
            //console.log('minava: \r\n'+$(window));
            //console.log(document.getElementByClassName('md-preview'));
            //content = s9e.TextFormatter.preview(content, document.getElementByClassName('md-preview'));
    ...
    buttons: [
      [{
        ...
        data: [{
          ...
          name: 'cmdUnderline',
          title: 'Underline',
          icon: { glyph: 'glyphicon glyphicon-underline', fa: 'fa fa-underline' },
          callback: function(e){
            // Give/remove * surround the selection
            var chunk, cursor, selected = e.getSelection(), content = e.getContent()
          ...
          title: 'Strikethrough',
          icon: { glyph: 'glyphicon glyphicon-text-strike', fa: 'fa fa-strikethrough' },
          callback: function(e){
            // Give/remove * surround the selection
            var chunk, cursor, selected = e.getSelection(), content = e.getContent()
          ...
          name: 'cmdInlineCode',
          title: 'Inline Code',
          icon: { glyph: 'glyphicon glyphicon-code', fa: 'fa fa-thumb-tack' },
          callback: function(e){
            // Give ![] surround the selection and prepend the image link
            var chunk, cursor, selected = e.getSelection(), content = e.getContent(), codeLang
          ...
          name: 'cmdBlockCode',
          title: 'Block Code',
          icon: { glyph: 'glyphicon glyphicon-code', fa: 'fa fa-code' },
          callback: function(e){
            // Give ![] surround the selection and prepend the image link
            var chunk, cursor, selected = e.getSelection(), content = e.getContent(), codeLang
            ...
            codeLang = prompt('Insert code language')

            if (codeLang != null) {
              // transform selection and set the cursor into chunked text
		e.replaceSelection('```'+codeLang+'\n'+chunk+'\n```')
            } else {
		e.replaceSelection('```\n'+chunk+'\n```')
	    }
              cursor = selected.start+6
        ...
        data: [{
          name: 'cmdUrl',
          title: 'URL/Link',
          icon: { glyph: 'glyphicon glyphicon-globe', fa: 'fa fa-link' },
          callback: function(e){
          ...
          callback: function(e){
            ...
            if (link != null) {
              // transform selection and set the cursor into chunked text
              e.replaceSelection('!['+chunk+']('+link+' "enter image link title here")')
              cursor = selected.start+2
        ...
        data: [{
          ...
          icon: { glyph: 'glyphicon glyphicon-list', fa: 'fa fa-ellipsis-h' },
          callback: function(e){
            // Prepend/Give - surround the selection
            var chunk, cursor, selected = e.getSelection(), content = e.getContent()
        ...
        data: [{
          ...
          icon: { glyph: 'glyphicon glyphicon-eye-open', fa: 'fa fa-eye' },
          callback: function(e){
